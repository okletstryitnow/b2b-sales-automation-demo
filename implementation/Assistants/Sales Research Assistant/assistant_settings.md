# Sales Research Assistant - Agent Specifications
...
Analysiert Leads und Accounts, um die besten Zielkunden basierend auf ICP-Score, Gesundheitsstatus, Rechnungsstatus und Ticketvolumen zu identifizieren.
...
- sales-pipeline-review-2024-11-22.md
- weekly-standup-2024-11-25.md
- product-overview.md

### Tabellen (4)

- leads.csv
- support-tickets-2024.csv
- invoices.csv
- accounts.csv
...
**Websuche**
Durchsucht das Web, um die Antwortqualität zu verbessern

**Daten Analyst**
Führt Code aus, um Daten zu analysieren, mit Excel-Dateien zu arbeiten, und mehr
